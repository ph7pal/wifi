...
<p><label>网站名称：</label><input class="form-control" name="websitename" id="websitename" type="text" value="<?php echo $info['websitename']; ?>" <?php echo $disabled;?>/></p>
<p><label>官方网站地址：</label><input class="form-control" name="websiteurl" id="websiteurl" type="text" value="<?php echo $info['websiteurl']; ?>" <?php echo $disabled;?>/></p>
<p><label>网站负责人：</label><input class="form-control" name="websiteowner" id="websiteowner" type="text" value="<?php echo $info['websiteowner']; ?>" <?php echo $disabled;?>/></p>
